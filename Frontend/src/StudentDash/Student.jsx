...
const StudentDashboard = ({ user = MOCK_STUDENT }) => {
  ...
  const calendarDays = useMemo(() => {
    ...
    const endDate = new Date(year, month, lastOfMonth.getDate() + (6 - endDay));
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto space-y-6 animate-fadeIn pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="grid grid-cols-7 gap-y-5 gap-x-2 text-center">
              ...
              {calendarDays.map((day, idx) => (
                ...
                >
                  <span
                    className={`text-xs font-bold mb-2 ${day.isCurrentMonth ? "text-gray-400" : "text-gray-300"}`}
                  >
                    {day.date.getDate()}
                  </span>
          ...
          {/* Side Section: Quick Stats & Recent History */}
