  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 outline-none focus:outline-none">
      <div
        ...
        onClick={onClose}
      ></div>
      <div className="relative w-full max-w-2xl bg-white dark:bg-[#151518] border border-slate-200 dark:border-[#222228] rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-[#222228] sticky top-0 bg-white/80 dark:bg-[#161619]/90 backdrop-blur-md rounded-t-2xl z-10">
